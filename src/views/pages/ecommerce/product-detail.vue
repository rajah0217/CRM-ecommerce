...
export default {
  ...
  computed: {
    ...
    productDetail() {
      return productData.find((user) => user.id === this.id);
    }
  }
};
</script>
            ...
            <BRow>
              <BCol cols="xl-5">
                <div class="product-detail">
                  <BTabs pills vertical nav-wrapper-class="col-3">
                    <BTab>
            ...
            <div class="mt-4">
              ...
              <div class="product-desc">
                ...
                >
                  ...
                  <BTab title="Specifications" active>
            ...
            <div class="mt-4">
              ...
              <div class="border p-4 rounded">
                ...
                <div class="border-bottom py-3">
                  ...
                  <div class="media d-flex align-items-startdia">
                    <div class="media-body flex-grow-1">
