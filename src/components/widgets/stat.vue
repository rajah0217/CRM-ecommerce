                ...
                <div>
                    <h4 class="mb-1 mt-1">
                        ...
                        <span data-plugin="counterup">
                            <count-to :startVal="1000" :endVal="34152" :duration="2000"></count-to>
                        </span>
                    </h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1">
                        <span data-plugin="counterup">
                            <count-to :startVal="100" :endVal="5643" :duration="2000"></count-to>
                        </span>
                    </h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <h4 class="mb-1 mt-1">
                        <span data-plugin="counterup">
                            <count-to :startVal="1000" :endVal="45254" :duration="2000"></count-to>
                        </span>
                    </h4>
